+++
title = "Nfc Card Player"
date = "2025-12-18"
author = "volteret4"
cover = ""
tags = ["música", "nfc"]
keywords = ["música", "nfc"]
description = "Lee tarjetas NFC para reproducir discos o lo que quieras"
...
> Se ha usado una raspberry 4 con raspbian y un lector NFC ACR122 para este [proyecto](https://github.com/volteret4/sobrinos)
...
Con el siguiente script podrás obtener el UID de cada tarjeta que mas tarde necesitaremos para reaccionar a las mismas.
...
Una vez detectadas, podemos editar el siguiente script modificando la parte en que se identifica cada tarjeta con la función a realizar.
...
Con este script podremos crear imagenes con el tamaño de las tarjetas (52mmx82mm):
CARA A:
- Portada
- Artista
- Album
        ...
        for font_path in font_paths:
            if os.path.exists(font_path):
                try:
                    ...
                    self.fonts['artist'] = ImageFont.truetype(font_path, 28)
                    self.fonts['info'] = ImageFont.truetype(font_path, 20)
                    self.fonts['track'] = ImageFont.truetype(font_path, 18)
                    break
                except Exception:
                    continue
